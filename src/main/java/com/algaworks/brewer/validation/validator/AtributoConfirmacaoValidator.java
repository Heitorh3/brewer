...
public class AtributoConfirmacaoValidator implements ConstraintValidator<AtributoConfirmacao, Object> {
	...
	@Override
	public boolean isValid(Object object, ConstraintValidatorContext contConstraintValidatorContext) {
		...
		if (!valido) {
			contConstraintValidatorContext.disableDefaultConstraintViolation();
			String mensagem = contConstraintValidatorContext.getDefaultConstraintMessageTemplate();
			ConstraintViolationBuilder violationBuilder = contConstraintValidatorContext.buildConstraintViolationWithTemplate(mensagem);
